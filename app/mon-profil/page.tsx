  ...
  return (
    <div className="text-white font-display min-h-screen flex flex-col relative w-full overflow-hidden">
      ...
      <div className="hidden lg:flex flex-col w-full">
        ...
        {/* ── Corps ── */}
        <div className="max-w-[1600px] mx-auto px-8 w-full pb-16">
...
function ProfileCoverBanner({ coverUrl, onLogout }: { coverUrl?: string; onLogout: () => void }) {
  return (
    <div className="relative w-full h-56 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 flex items-center justify-end px-8 pt-4 max-w-[1600px] mx-auto">
        <button
          onClick={onLogout}
