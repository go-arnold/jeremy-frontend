...
export const metadata = {
  title: 'Freestyles - Art du Kivu',
};

export default async function FreestylesPage() {
  const data = await getFreestyles();
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 to-black pt-32 pb-20">
      <div className="container mx-auto px-4">
        ...
        <h1 className="text-5xl font-bold text-white mb-4">Freestyles</h1>
        <p className="text-white/60 mb-12">Découvrez les meilleurs freestyles de nos artistes.</p>
        ...
        {data.results?.length > 0 ? (
          ...
          <div className="text-center py-20">
            <p className="text-white/60">Aucun freestyle disponible</p>
          </div>
        )}
      </div>
    </main>
