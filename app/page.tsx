...
export default async function HomePage() {
  ...
  return (
    ...
    <div className="flex flex-col w-full">
      ...
      {/*
        Sections internes : centrées avec max-w-[1800px] sur desktop
        Chaque composant gère son propre lg:max-w-[1800px] lg:mx-auto lg:px-8
      */}
      ...
      <div className="
        mt-10 px-4
        lg:px-8 lg:max-w-[1800px] lg:mx-auto lg:w-full
