...
export default function ArtisteDetailHero({ artiste }: Props) {
  return (
    ...
    ">
      ...
      <div className="absolute top-0 left-0 w-full z-20 flex items-center justify-between p-4 pt-14 lg:pt-6 lg:px-8 lg:mx-auto lg:left-0 lg:right-0">
        <Link
          href="/artistes"
      ...
      <div className="hidden lg:block relative z-10 w-full">
        <div className="mx-auto px-8 pb-14">
