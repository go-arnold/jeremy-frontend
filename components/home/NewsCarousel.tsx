...
export default function NewsCarousel({ cards }: Props) {
  ...
  return (
    <section className="mt-4 flex flex-col gap-4 lg:mt-8">
      <div className="flex items-center justify-between px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:w-full">
      ...
      <div className="hidden lg:grid lg:grid-cols-3 lg:gap-4 lg:px-8 lg:max-w-7xl lg:mx-auto lg:w-full">
