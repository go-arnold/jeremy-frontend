...
export default function ContentCarousel({ cards }: Props) {
  return (
    <section className="mt-8 lg:mt-12">
      <div className="flex items-center justify-between px-4 mb-4 lg:px-8 lg:max-w-[1600px] lg:mx-auto">
      ...
      <div className="hidden lg:grid lg:grid-cols-4 lg:gap-5 lg:px-8 lg:max-w-[1600px] lg:mx-auto">
        {cards.map((card) => (
          <div
            key={card.id}
